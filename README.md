...
루트를 제거한 변형식인 L1^2 = L2^2 = L3^2를 이용해 해당 방정식을 서로 연립하여 외심의 좌표를 구하거나,

직선 L1, L2, L3의 중심 좌표의 값과 특정 선의 기울기를 계산하여, 중간점과 기울기를 이용하여 직선yy1, 직선 m(xx1)의 방정식을 찾는다.

마찬가지로 다른선의 방정식을 구하고, 이 두 선의 교점이 바로 삼각형의 외심의 좌표 D(X,Y)이다.
